...
photo1 = load_resized_image("C:/Users\kruth/Downloads/insect-detection-using-yolo-v8-main/insect-detection-using-yolo-v8-main/ins1.png", (300, 400))
label1 = tk.Label(image_frame, image=photo1)
label1.grid(row=0, column=0)

photo2 = load_resized_image("C:/Users\kruth/Downloads/insect-detection-using-yolo-v8-main/insect-detection-using-yolo-v8-main/ins2.png", (300, 400))
label2 = tk.Label(image_frame, image=photo2)
label2.grid(row=0, column=1)

photo3 = load_resized_image("C:/Users\kruth/Downloads/insect-detection-using-yolo-v8-main/insect-detection-using-yolo-v8-main/ins3.png", (300, 400))
label3 = tk.Label(image_frame, image=photo3)
label3.grid(row=1, column=0)

photo4 = load_resized_image("C:/Users\kruth/Downloads/insect-detection-using-yolo-v8-main/insect-detection-using-yolo-v8-main/ins4.png", (300, 400))
